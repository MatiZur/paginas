...
function fetchCharacters(page, name) {
  ...
  fetch(url)
    ...
    .then(data => {
      ...
      if(page>=1 && page <=9 && lastPage>=1 && lastPage <=9) document.querySelector('#page').textContent = `0${page}/0${lastPage}`;
      else if(page>=1 && page <=9 && lastPage>9) document.querySelector('#page').textContent = `0${page}/${lastPage}`;
      else if(page>9 && lastPage>=1 && lastPage<=9) document.querySelector('#page').textContent = `${page}/0${lastPage}`;
      else if(page>9 && lastPage>9) document.querySelector('#page').textContent = `${page}/${lastPage}`;
